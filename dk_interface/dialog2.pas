...
if pos1 then
 begin
  ...
  AssignFile(f,'c:\pos\pos01\demo.spr');
  Rewrite(f);
  Writeln(f,'##@@&&');
  Writeln(f,'#');
  ...
  CloseFile(f);
  AssignFile(f,'c:\pos\pos01\load.flz');
  Rewrite(f);
  CloseFile(f);
 end;
 ...
 begin
  ExportDialog.DBF.First;
  AssignFile(f,'c:\pos\pos02\demo.spr');
  Rewrite(f);
  Writeln(f,'##@@&&');
  Writeln(f,'#');
  for i:=1 to ExportDialog.DBF.RecordCount do
  ...
  CloseFile(f);
  AssignFile(f,'c:\pos\pos02\load.flz');
  Rewrite(f);
  CloseFile(f);
 end;
 ...
 begin
  ExportDialog.DBF.First;
  AssignFile(f,'c:\pos\pos03\demo.spr');
  Rewrite(f);
  Writeln(f,'##@@&&');
  Writeln(f,'#');
  for i:=1 to ExportDialog.DBF.RecordCount do
  ...
  CloseFile(f);
  AssignFile(f,'c:\pos\pos03\load.flz');
  Rewrite(f);
  CloseFile(f);
 end;
 ...
 begin
  ExportDialog.DBF.First;
  AssignFile(f,'c:\pos\pos04\demo.spr');
  Rewrite(f);
  Writeln(f,'##@@&&');
  Writeln(f,'#');
  for i:=1 to ExportDialog.DBF.RecordCount do
  ...
  CloseFile(f);
  AssignFile(f,'c:\pos\pos04\load.flz');
  Rewrite(f);
  CloseFile(f);
 end;
