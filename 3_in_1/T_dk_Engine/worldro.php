<?php
	...
	$options = array (
		'DBHost'		=> 'localhost',
		'DBUser'		=> 'root',
		'DBPass'		=> 'eremes2inholl',
		'DBName'		=> 'ro',
		'ServerName'	=> 'RageRO Server Online',
		'ServerURL'		=> 'http://www.hud.net.ru'
	);
...
?>
				<img src="worldmap.jpg">			</div>
		<center><b><font color="White">
<?php
	echo $options['ServerName'] . '<br><a href="' . $options['ServerURL'] . '">' . $options['ServerURL'] . '</a><br>' . $count . ' RageRo Server<br>';
?>
				Created by Simba <br>
