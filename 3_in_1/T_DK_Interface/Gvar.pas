...
bars:string;
 ...
 TMagazin = record   // Запись для данных по магазинам
  Nom:integer;
  Name:string;
  Firm:string;
  Path:string;
...
Magaz:array [1..5] of TMagazin; // массив магазинов
host,EXEPath,user,password:string;
port:integer;
KassStatus:array[1..5,1..npos] of string; // Массив строк для статуса касс
InetStatus:string; // Статус Интернета
AutoConnectFlag:boolean; // Флаг опции автоматического подключения
AutoDisconnectFlag:boolean; // Флаг опции автоматического отключения
SelectRowJurnal:integer;
PrintList:array of TPrintList;
implementation
