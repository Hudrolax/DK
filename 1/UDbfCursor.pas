...
type
  TOnBracketStr = procedure(First,Last:PChar;NoFirst,NoLast:boolean;var Accept: Boolean) of object;
  TOnBracketNum = procedure(First,Last:double;NoFirst,NoLast:boolean;var Accept: Boolean) of object;
//====================================================================
